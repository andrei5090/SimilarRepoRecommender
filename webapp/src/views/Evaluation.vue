  ...
  data() {
    return {
      ...
      scenarios: [
        ...
        'A small company specialising in HR management wants to improve their API performance. They provide an API to their clients that allow them to input their HR data and provide metrics and statistics about employees\' performance. After an internal audit, they observed that some metrics and statistics take too much time and resources to compute, but the results are relatively constant for most of their clients. They want to solve this issue cost-effectively since this performance issue has already severely affected their income. Please provide a query that may lead to an already built solution for this type of application or a stack of technologies that may help solve this task. Please focus more on the tags than on the textual search. Please keep in mind that the order of the tags is changing and provides you with recommendations when you input at least one tag.'
      ],
      evalStatus: false,
